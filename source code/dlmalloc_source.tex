...
\usepackage[top=2.3cm, bottom=1.5cm, inner=1.5cm, outer=1.5cm]{geometry}
\usepackage{titletoc}
\usepackage{tocloft}
...
\lstset{
  ...
  mathescape=true,
  basewidth=0.5em,
  basicstyle=\ttfamily\fontsize{13pt}{14pt}\selectfont,
...
\title{\Huge Complete source code of {\tt dlmalloc}}
\author{\LARGE Written by Doug Lea \\[5pt] \LARGE Typeset by John Wickerson}
\date{}
...
\end{lstlisting}
\chapter{Declarations of public routines}
\begin{lstlisting}
...
#endif
\end{lstlisting}
\chapter{size\_t and alignment properties}
\begin{lstlisting}
...
£\section{Chunks sizes and alignments}£
...
£\section{Operations on head and foot fields}£
...
#endif /* MMAP_CLEARS */
£\section{Overlaid data structures}£
/*
...
£\section{Global malloc\_state and malloc\_params}£
...
£\section{Operations on bin maps}£
...
\end{lstlisting}
\chapter{Operations on smallbins and trees}
\begin{lstlisting}
/*
  ...
  compilers.
*/
£\section{Operations on smallbins}£
...
\chapter{Direct-mmapping chunks}
\begin{lstlisting}
/*
...
\chapter{System allocation and deallocation}
\begin{lstlisting}
...
\chapter{Support for public routines}
\begin{lstlisting}
...
£\section{comalloc/coalloc support}£
...
\chapter{Postscript}
\begin{lstlisting}
£\section{Alternative MORECORE functions}£
/*
